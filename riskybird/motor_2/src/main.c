 ...
 *
 * Motor speed control via PWM for 2 motors (GPIOs 20, 21).
...
int main(void)
{
	...
	printk("PWM motor speed control - 2 motors (high throttle)\n");
	...
	printk("Motors on channels %d,%d, period %u nsec, pulse %u nsec\n",
	...
	printk("Both motors at high throttle.\n");
