...
#
# Generic toolchain configuration dispatcher for Zephyr SDK
# This file routes to either gnu or llvm toolchain configuration
...
# Include the appropriate toolchain configuration
if(_sdk_toolchain_variant STREQUAL "llvm")
  include(${CMAKE_CURRENT_LIST_DIR}/llvm/generic.cmake)
elseif(_sdk_toolchain_variant STREQUAL "gnu")
  include(${CMAKE_CURRENT_LIST_DIR}/gnu/generic.cmake)
else()
