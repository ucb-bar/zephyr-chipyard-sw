...
def main():
    ...
    ap.add_argument("-p", "--port", default="/dev/serial/by-id/usb-Silicon_Labs_CP2102N_USB_to_UART_Bridge_Controller_30e36a98d344ed11874fc6c90a86e0b4-if00-port0", help="Serial port (default: /dev/ttyUSB0)")
