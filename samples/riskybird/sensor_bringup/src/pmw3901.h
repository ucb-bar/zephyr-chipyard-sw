 ...
 *
 * PMW3901 Optical Flow Sensor (SPI) - minimal driver helpers
 *
 * Note: This is a simple bring-up oriented implementation (not a full Zephyr
 * sensor driver). It uses Zephyr's SPI and GPIO APIs directly.
 */
...
struct pmw3901_config {
	...
	struct gpio_dt_spec reset_gpio; /* Optional: active-low */
};
