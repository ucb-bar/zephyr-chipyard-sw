...
The base optimize loop in modelblaster.pipeline.generate_kernels uses spike to
...
from modelblaster.optimize.firesim_eval.evaluator import (  # noqa: F401
    FiresimEvalConfig,
    FiresimEvalResult,
    FiresimEvaluator,
    evaluate_top_k,
)
from modelblaster.optimize.firesim_eval.cache_aware_prompt import (  # noqa: F401
